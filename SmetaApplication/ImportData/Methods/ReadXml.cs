...
namespace ImportData.Models
{
    class ReadXml
    {
        ...
        //public static List<Dogovor> FilterDogovor(FilterClass filtr)
        //{
        //    List<Dogovor> result = new List<Dogovor>();
        //    List<Dogovor> list = new List<Dogovor>();
        //    try
        //    {
        //        list = SelectDogovor(null, null, 0);
        //        string ids = "";
        //        int j = 0;
        //        //if (filtr.cheked[8] == 1)
        //        //{
        ...
        //            {
        //            //MessageBox.Show(list[i].Sana.ToShortDateString() + ":" + filtr.Gacha.ToShortDateString());
        //            //MessageBox.Show((j < filtr.Son).ToString() + ":" + (filtr.Dan <= list[i].Sana).ToString() + ":" + (list[i].Sana <= filtr.Gacha).ToString());
        //            if (j < filtr.Son && filtr.Dan <= list[i].Sana && list[i].Sana <= filtr.Gacha)
        //                {
        ...
        //        //    for (int i = 0; i < list.Count; i++)
        //        //    {
        //        //        if (j < filtr.Son && filtr.Dan <= list[i].Sana && list[i].Sana <= filtr.Gacha && ids.IndexOf(list[i].IshTuriId.ToString()) > -1)
        //        //        {
        //        //            j++;
        //        //            result.Add(list[i]);
        //        //        }
